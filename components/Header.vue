                                            ...
                                            <div class="u-header-sidebar__footer-offset">
                                                ...
                                                <div class="js-scrollbar u-sidebar__body">
                                                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                        <!-- Logo -->
                                                        <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center mb-3" href="/" aria-label="MAALHOUSE">
                                                            <img src="~/assets/img/Logo/logo.png" width="175.748px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52" style="margin-bottom: 0;">
                                                        </a>
                                                        <!-- End Logo -->
                                                ...
                                                <div class="row u-header__mega-menu-wrapper">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="/" class="nav-link u-header__sub-menu-nav-link">Home v1</a></li>

export default {
  ...
  head: {
    ...
    script: [
      { src: "vendor/jquery/distt/jquery.min.js" },
      { src: "vendor/jquery-migrate/distt/jquery-migrate.min.js" },
      { src: "vendor/popper.js/distt/umd/popper.min.js" },
      ...
      { src: "vendor/svg-injector/distt/svg-injector.min.js" },
      { src: "vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js" },
      { src: "vendor/jquery-validation/distt/jquery.validate.min.js" },
